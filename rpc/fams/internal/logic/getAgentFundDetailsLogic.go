...
// GetAgentFundDetails 获取代理资金明细
func (l *GetAgentFundDetailsLogic) GetAgentFundDetails(in *famsRpc.GetAgentFundDetailsReq) (*famsRpc.ListFundDetailsResp, error) {
	// 获取代理资金明细
	fundDetails, total, err := l.svcCtx.FundDetailRepository.GetAgentFundDetails(
		uint(in.AgentId),
		in.IncludeSubAgents,
		in.PageReq.Page,
		in.PageReq.PageSize,
